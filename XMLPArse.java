...
public class XMLPArse {
	...
	public static void main(String[] args) throws SAXException, Exception {
		...
		DiffElements processXMLDiffDocument = processXMLDiffDocument(sourceFile,targetFile);
		
		List<XMLDiffMap> addedElements = processXMLDiffDocument.getAddedElements();
		List<XMLDiffMap> deletedElements = processXMLDiffDocument.getDeletedElements();
	...
	private static DiffElements processXMLDiffDocument(File sourceFile, File targetFile) throws ParserConfigurationException, SAXException, IOException {
